...
const app=express();const PORT=Number(process.env.PORT||3000),HOST='127.0.0.1',DATA_DIR=process.env.KAWADER_DATA_DIR||__dirname,DATA=path.join(DATA_DIR,'data.json');
